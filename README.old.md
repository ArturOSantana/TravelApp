...
**Desenvolvimento de Sistemas | Versão 1.0.0**

[📚 Documentação Completa](docs/README.md) • [🚀 Início Rápido](#-início-rápido) • [🤝 Contribuir](docs/desenvolvimento/CONTRIBUTING.md)
...
### 🗺️ Gestão de Viagens
- Viagens individuais ou em grupo (até 20 membros)
- Suporte a viagens planejadas ou nômades
...
### 📔 Diário de Viagem
- Entradas com texto, fotos e localização
- Análise de humor (mood tracking)
- Álbum público compartilhável
...
- Integração com Maps e Calendar

### 🔒 Segurança
- Botão de pânico com SMS automático
...
# 3. Configurar Firebase (opcional para desenvolvimento)
...
- [**Índice Geral**](docs/README.md) - Navegação completa da documentação

### 🔧 Desenvolvimento
- [Como Executar no Emulador](docs/desenvolvimento/COMO_EXECUTAR_NO_EMULADOR.md)
- [Configuração do Firebase](docs/desenvolvimento/CONFIGURACAO_FIREBASE_HOSTING.md)
- [Guia de Contribuição](docs/desenvolvimento/CONTRIBUTING.md)

### 🌐 APIs e Integrações
- [APIs Gratuitas Integradas](docs/apis/APIS_GRATUITAS_ROTEIRO_INTELIGENTE.md)
- [Implementação das APIs](docs/apis/IMPLEMENTACAO_APIS_FINAL.md)
- [Comparação Google Maps vs Alternativas](docs/apis/COMPARACAO_GOOGLE_MAPS_VS_ALTERNATIVAS.md)
- [Alternativa OpenTripMap](docs/apis/ALTERNATIVA_OPENTRIPMAP.md)

### 📝 Planejamento
- [Novas Funcionalidades](docs/planejamento/NOVAS_FUNCIONALIDADES.md)
- [Plano de Melhorias](docs/planejamento/PLANO_MELHORIAS_FUNCIONALIDADES.md)
- [Melhorias de Segurança](docs/planejamento/MELHORIAS_SEGURANCA.md)
- [Melhorias do Journal](docs/planejamento/MELHORIAS_JOURNAL_PLANEJADAS.md)
- [Guia de Compartilhamento](docs/planejamento/GUIA_COMPARTILHAMENTO_JOURNAL.md)

### 🎨 Assets e Design
- [Documentação de Design](docs/assets/AppTravel.pdf)
- [Estrutura do Banco de Dados](docs/planejamento/banco.json)
