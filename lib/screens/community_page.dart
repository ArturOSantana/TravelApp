...
class _CommunityPageState extends State<CommunityPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Comunidade", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22)),
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text(post.category, style: const TextStyle(color: Colors.indigo, fontSize: 12, fontWeight: FontWeight.bold)),
                    ],
                  ),
                  ...
                  child: ListView(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Expanded(child: Text(post.name, style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold))),
                          IconButton(
                      ...
                      if (post.comments.isEmpty)
                        const Padding(
                          ...
                          child: Center(child: Text("Ainda não há comentários.", style: TextStyle(color: Colors.grey))),
                        )
                      else
      ...
      child: Column(
        ...
        children: [
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text(c.text, style: const TextStyle(fontSize: 14, color: Colors.black87)),
                    ],
                  ),
                ),
              ),
          ...
          Padding(
            ...
            child: Text(DateFormat('dd/MM HH:mm').format(c.createdAt), style: TextStyle(fontSize: 10, color: Colors.grey[500])),
          ),
        ],
      ),
    );
